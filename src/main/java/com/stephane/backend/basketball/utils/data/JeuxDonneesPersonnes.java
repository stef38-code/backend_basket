...
public class JeuxDonneesPersonnes extends JeuxDonneesContacts {
    ...
    protected Personne getPersonneMajeur(Role role, Genre genre, Categorie categorie) {
        Personne personne = getPersonne(18, 65, genre, role, categorie);
        return personne;

    }

    protected Personne getPersonneMineur(int minAge,
                                         int maxAge, Genre genre, Categorie categorie) {
        return getPersonne(minAge, maxAge, genre, Role.ENFANT, categorie);
    }

    private Personne getPersonne(int minAge,
                                 int maxAge, Genre genre, Role role, Categorie categorie) {
